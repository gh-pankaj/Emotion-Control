...
descriminator_dataset_file="datasets/SemEval2018_emotion_dataset_"+emotion+".tsv"
...
if save_model:
    with open("{}_classifier_head_meta.json".format(emotion),
              "w") as meta_file:
...
for epoch in range(epochs):
    ...
    if save_model:
        ...
        torch.save(discriminator.get_classifier().state_dict(),
                   "{}_classifier_head_epoch_{}.pt".format(emotion,
                                                           epoch + 1))
...
shutil.copyfile(emotion+'_classifier_head_epoch_'+str(epochs)+'.pt', emotion+'_classifier_head.pt')

...
discrim_meta_file=emotion+"_classifier_head_meta.json"
discrim_weights=emotion+"_classifier_head.pt"
eval_dataset_type="preference"
eval_response_files={"preference": "response-preference-emotion-"+emotion+".json", "opinion": "response-opinion-emotion-"+emotion+".json"}

idx2class = [emotion,"no-"+emotion]
